---
title: "Conventions & Object Schemas - Deepvue Workflows API"
description: "Reference for Workflows API conventions and object shapes. Timestamps, the list envelope, absent versus null, and the Workflow, Run, Check, and ReviewFlag schemas."
---
...
<Columns cols="3">
  <Card title="Run status lifecycle" icon="activity" href="/run-lifecycle">
    The six statuses a run moves through, and which are terminal.
  </Card>

  <Card title="Reviews and decisions" icon="user-check" href="/reviews">
    How the decision axis works alongside status.
  </Card>

  <Card title="Errors" icon="alert-circle" href="/errors">
    The transport envelope and the five run error codes.
  </Card>
</Columns>
