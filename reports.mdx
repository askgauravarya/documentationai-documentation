---
title: "Verification Reports - JSON Content Model & PDF"
description: "Read a Deepvue Workflows verification report as JSON for your own UI, or as a rendered PDF for archiving. Includes the full content model and presence rules."
---
...
<Columns cols="3">
  <Card title="Reviews and decisions" icon="user-check" href="/reviews">
    Record the verdict that closes a flagged card.
  </Card>

  <Card title="Conventions and objects" icon="layers" href="/concepts">
    Presence rules and the object model behind the report.
  </Card>

  <Card title="Webhooks" icon="bell" href="/webhooks">
    Know when a run is terminal and its report is ready.
  </Card>
</Columns>
